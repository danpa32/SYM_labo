...
public class MainActivityWear extends WearableActivity {
    ...
    private void updateColor() {
        ...
        PutDataMapRequest dataMap = PutDataMapRequest.create(Constants.PATH_COLORS);
        dataMap.getDataMap().putInt(Constants.COLORS[0], r);
        dataMap.getDataMap().putInt(Constants.COLORS[1], g);
        dataMap.getDataMap().putInt(Constants.COLORS[2], b);

        Task<DataItem> putTask = mDataClient.putDataItem(dataMap.asPutDataRequest());
